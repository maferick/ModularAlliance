-- 011_rights_add_module_slug.sql
-- Self-heal: add rights.module_slug so admin/rights can group by module without fatals.
-- Works even if IF NOT EXISTS isn't supported by your MariaDB/MySQL variant.
