...
final class App
{
    ...
    public static function boot(): self
    {
        ...
        $app->menu->register(['slug'=>'admin.modules','title'=>'Modules','url'=>'/admin/modules','sort_order'=>45,'area'=>'admin_top','right_slug'=>'admin.rights']);

        CoreRights::register($app->db);
        ...
        AdminRoutes::register($app, $hasRight);
